...
public class NonSerializableType {
    ...
    public NonSerializableType() {
    }

    public NonSerializableType(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object obj) {
        ...
        NonSerializableType other = (NonSerializableType) obj;
    ...
    public String toString() {
        return "NonSerializableType [id=" + id + ", number=" + number + ", description=" + description
                + ", children=" + children + "]";
    }
