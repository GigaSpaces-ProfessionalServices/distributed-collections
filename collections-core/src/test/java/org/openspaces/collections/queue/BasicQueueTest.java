 ...
 */
public abstract class BasicQueueTest<T> extends AbstractCollectionTest<T> {
    private static final Logger LOG = LoggerFactory.getLogger(BasicQueueTest.class);
    ...
    public BasicQueueTest(List<T> elements) {
        super(elements);
    }
